package Chapix::Xaa::Admin::Controller;
...
sub display {
    ...
    if($_REQUEST->{'View'} eq 'edit' or $_REQUEST->{'View'} eq 'add'){
        print Chapix::Admin::Layout::print( Chapix::Xaa::Admin::View::display_form() );        
    }else{
        print Chapix::Admin::Layout::print( Chapix::Xaa::Admin::View::display_home() );
    }
}
