    ...
    chardinJs = (function() {
      ...
      chardinJs.prototype._add_overlay_layer = function() {
        ...
        return setTimeout(function() {
          styleText += "opacity: .7;-ms-filter: 'progid:DXImageTransform.Microsoft.Alpha(Opacity=80)';filter: alpha(opacity=80);";
      ...
      chardinJs.prototype._show_element = function(element) {
        ...
        if (current_element_position === 'fixed'){
          return element.className += " chardinjs-fixed-position";
        }else if (current_element_position !== "absolute" && current_element_position !== "relative") {
